...
ENV B19_BENCHMARK_ENABLED=true                                                    \
    ...
    B19_CACHE_CHECK_ENABLED=true                                                  \
    B19_CACHE_GUARD_ENABLED=true                                                  \
    B19_CACHE_GUARD_STAMP=.b19-cache-stamp                                        \
    B19_CACHE_GUARD_TIMEOUT=900                                                   \
    B19_CACHE_CHECK_TIMEOUT=2                                                     \
    B19_CACHE_PATH="${B19_CACHE_PATH}"                                            \
    B19_COMMAND_PATH=/command.d                                                   \
    B19_DEPS_PATH=/deps                                                           \
    B19_DOCKER_GID=995                                                            \
    B19_DOWNLOAD_ATTEMPTS=3                                                       \
